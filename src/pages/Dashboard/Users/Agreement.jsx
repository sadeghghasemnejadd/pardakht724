...
export default function NationalId() {
  ...
  const acceptNationalId = () => {
    client
      .post(
        `/users/${user.id}/profile/agreement
    `,
  ...
  const handleDownloadFile = () => {
    client
      .get(`/users/${id}/profile/agreement`, {
        headers: {
          authorization: `Bearer ${localStorage.getItem("token")}`,
        },
      })
        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-4">
              ...
              {/* <InputGroup className="mb-3"> */}
              {/* <InputGroupAddon addonType="prepend">دانلود</InputGroupAddon> */}
              {/* <Input value="">
                  <a href={`/users/${id}/agreement`} download target="_blank"></a>
                </Input> */}
              {/* </InputGroup> */}
            </div>
          </div>
