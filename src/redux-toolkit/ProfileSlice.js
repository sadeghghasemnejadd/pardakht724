...
export const setNationalId = createAsyncThunk(
    ...
    async (values) => {
        try {
            const token = localStorage.getItem('token')
            const { data } = await axiosInstance.post('/auth/profile/national-id', values, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            })
...
export const setAgreement = createAsyncThunk(
    ...
    async (values) => {
        try {
            const token = localStorage.getItem('token')
            const { data } = await axiosInstance.post('/auth/profile/agreement', values, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            })
...
export const setHomePhone = createAsyncThunk(
    'setHomePhone',
    async (values) => {
        try {
            const token = localStorage.getItem('token')
            const { data } = await axiosInstance.post('/auth/profile/home-phone', values, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            })
...
export const setConfirmHomePhone = createAsyncThunk(
    ...
    async (values) => {
        try {
            const token = localStorage.getItem('token')
            const { data } = await axiosInstance.post('/auth/profile/confirm-home-phone', values, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            })
